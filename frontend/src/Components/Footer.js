    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        <h1>Contact Us</h1>
                        <p>Rvs CAS</p>
                        <p>Affliated By Bharathiar University</p>
                        <p>Cbe - 641605</p>
                        <p>Tamil Nadu</p>
                        <p>India</p>
                        <p><b>Email:</b>Rvscas@gmail.com</p>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2020 copyright all right reserved<br /><span>Designed with ❤️ by Gowtham</span></p>
            </div>
        </div>
    )
}
